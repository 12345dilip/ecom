  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text(GrocartLocalizations.of(context)!.confirm!,
            ...
            ListView(
              children: <Widget>[
                Container(
                  ...
                  child: Text(
                      GrocartLocalizations.of(context)!.ironBox!.toUpperCase(),
                ...
                Container(
                  ...
                  child: Row(
                    children: <Widget>[
                      ...
                      Text(GrocartLocalizations.of(context)!.instruction!,
                          style: Theme.of(context).textTheme.caption!.copyWith(
                              fontSize: 11.7, color: Color(0xffb2b2b2))),
                      Spacer(),
                      Text(GrocartLocalizations.of(context)!.apply!,
                          style: Theme.of(context)
                              .textTheme
                              .caption!
                ...
                Container(
                  ...
                  child: Row(
                      ...
                      children: <Widget>[
                        Text(
                          GrocartLocalizations.of(context)!.sub!,
                ...
                Container(
                  ...
                  child: Row(
                      ...
                      children: <Widget>[
                        Text(
                          GrocartLocalizations.of(context)!.service!,
                          style: Theme.of(context).textTheme.caption,
                        ),
                        Text(
                          '\$ 1.50',
                ...
                Container(
                  ...
                  child: Row(
                      ...
                      children: <Widget>[
                        Text(
                          GrocartLocalizations.of(context)!.amount!,
                          style: Theme.of(context)
                              .textTheme
                              .caption!
            ...
            Align(
              ...
              child: Column(
                ...
                children: <Widget>[
                        ...
                        children: <Widget>[
                          Row(
                            children: <Widget>[
                              ...
                              Text(GrocartLocalizations.of(context)!.deliver!,
                                  style: Theme.of(context)
                                      .textTheme
                                      .caption!
                                      .copyWith(
                                          color: disabledColor,
                                          fontWeight: FontWeight.bold)),
                              Text(GrocartLocalizations.of(context)!.homeText!,
                                  style: Theme.of(context)
                                      .textTheme
                                      .caption!
                                      .copyWith(
                  ...
                  BottomBar(
                    typeOftext:
                        GrocartLocalizations.of(context)!.pay! + " \$ 21.00",
                    onClick: () =>
