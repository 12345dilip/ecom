      ...
      appBar: PreferredSize(
        ...
        child: Padding(
          ...
          child: AppBar(backgroundColor: Theme.of(context).cardColor,
            ...
            centerTitle: true,
            title: Text(GrocartLocalizations.of(context)!.rateNowSite!,
        ...
        Stack(
          children: [
            ListView(
              children: [
                Text(
                  GrocartLocalizations.of(context)!.how!,
                ...
                Text(
                  GrocartLocalizations.of(context)!.withR!,
                  textAlign: TextAlign.center,
                  style: Theme.of(context)
                      .textTheme
                      .headline4!
                ...
                Padding(
                  ...
                  child: Align(
                    ...
                    child: Text(
                      GrocartLocalizations.of(context)!.addReview!.toUpperCase(),
                ...
                Padding(
                  ...
                  child: EntryField(
                    null,
                    GrocartLocalizations.of(context)!.writeReview,
                  ),
                ),
                SizedBox(
                  height: 80,
            ...
            Align(
              ...
              child: BottomBar(
                  ...
                  typeOftext: GrocartLocalizations.of(context)!.feedback),
            )
          ],
        ),
