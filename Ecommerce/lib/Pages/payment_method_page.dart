            ...
            flexibleSpace: Container(
              ...
              child: Column(
                ...
                children: <Widget>[
                  ...
                  Text(
                    SpicyLocalizations.of(context)!.selectPayment!,
                  ...
                  Text(
                    SpicyLocalizations.of(context)!.amount! + '\$ 21.00',
          ...
          child: Column(
            ...
            children: <Widget>[
              ...
              ListTile(
                ...
                title: Text(
                  SpicyLocalizations.of(context)!.walletSite!,
              ...
              Container(
                ...
                color: Theme.of(context).cardColor,
                child: Text(SpicyLocalizations.of(context)!.card!.toUpperCase(),
              ...
              Container(
                ...
                color: Theme.of(context).cardColor,
                child: Text(
                  SpicyLocalizations.of(context)!.cash!.toUpperCase(),
                  style: Theme.of(context).textTheme.caption!.copyWith(
                      color: disabledColor,
                      fontWeight: FontWeight.bold,
                      letterSpacing: 0.67),
              ...
              BuildItemsListTile(
                ...
                textType: SpicyLocalizations.of(context)!.cod,
                onPressed: () =>
                    Navigator.pushNamed(context, PageRoutes.orderChoosePlaced),
              ),
              Container(
                ...
                color: Theme.of(context).cardColor,
                child: Text(
                  SpicyLocalizations.of(context)!.other!.toUpperCase(),
                  style: Theme.of(context).textTheme.caption!.copyWith(
                      color: disabledColor,
                      fontWeight: FontWeight.bold,
                      letterSpacing: 0.67),
