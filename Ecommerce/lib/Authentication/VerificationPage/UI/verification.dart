  ...
  Widget build(BuildContext context) {
    return Scaffold(backgroundColor: Theme.of(context).cardColor,
      appBar: AppBar(backgroundColor: Theme.of(context).cardColor,
        ...
        elevation: 0.0,
        title: Text(
          SpicyLocalizations.of(context)!.verification!,
            ...
            child: Column(
              ...
              children: <Widget>[
                ...
                Padding(
                  ...
                  child: Text(
                    SpicyLocalizations.of(context)!.enterVerification!,
                ...
                Padding(
                  ...
                  child: EntryField(
                      SpicyLocalizations.of(context)!.verificationCode,
                      '1 2 3 4 5 6'),
                ),
                Spacer(),
                Row(
                  ...
                  children: <Widget>[
                    ...
                    TextButton(
                        ...
                        child: FadedScaleAnimation(
                          Text(
                            SpicyLocalizations.of(context)!.resend!,
                            style: TextStyle(
                              fontSize: 16.7,
