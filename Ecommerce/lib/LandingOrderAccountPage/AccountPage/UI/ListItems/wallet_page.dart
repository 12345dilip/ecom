  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text(SpicyLocalizations.of(context)!.walletSite!,
    ...
    return ListView(
      children: <Widget>[
                ...
                Container(
                  ...
                  child: FadedScaleAnimation(
                    TextButton(
                      ...
                      child: Text(
                        SpicyLocalizations.of(context)!.addingAmount!,
        ...
        Container(
          ...
          child: Text(
            SpicyLocalizations.of(context)!.recent!,
          ...
          child: Row(
            children: <Widget>[
              Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: <Widget>[
                  Text(SpicyLocalizations.of(context)!.droneCam!,
                      style: Theme.of(context)
                          .textTheme
                          .caption!
                          .copyWith(fontWeight: FontWeight.bold)),
          ...
          child: Row(
            children: <Widget>[
              Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: <Widget>[
                  Text(SpicyLocalizations.of(context)!.penDrive!,
                      style: Theme.of(context)
                          .textTheme
                          .caption!
                          .copyWith(fontWeight: FontWeight.bold)),
