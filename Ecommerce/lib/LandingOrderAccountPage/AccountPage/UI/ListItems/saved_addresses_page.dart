  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        appBar: AppBar(
          ...
          title: Text(
            SpicyLocalizations.of(context)!.saved!,
      ...
      Column(
        ...
        children: <Widget>[
          ...
          BottomBar(
            ...
            typeOftext: '+ ' + SpicyLocalizations.of(context)!.addNew!,
