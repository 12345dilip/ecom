...
class _FavouriteState extends State<Favourite> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        backgroundColor: Theme.of(context).cardColor,
        title: Text(SpicyLocalizations.of(context)!.fav!,
            ...
            child: Row(
              ...
              children: <Widget>[
                ...
                Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: <Widget>[
                    Text(SpicyLocalizations.of(context)!.electronics!,
                        style: Theme.of(context).textTheme.subtitle2!.copyWith(
                            color: Theme.of(context).secondaryHeaderColor)),
                    SizedBox(height: 8.0),
                    Text(SpicyLocalizations.of(context)!.mobile!,
                        style: Theme.of(context)
                            .textTheme
                            .caption!
                            .copyWith(color: lightTextColor, fontSize: 10.0)),
            ...
            child: Row(
              ...
              children: <Widget>[
                ...
                Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: <Widget>[
                    Text(SpicyLocalizations.of(context)!.lens!,
                        style: Theme.of(context).textTheme.subtitle2!.copyWith(
                            color: Theme.of(context).secondaryHeaderColor)),
                    SizedBox(height: 8.0),
            ...
            child: Row(
              ...
              children: <Widget>[
                ...
                Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: <Widget>[
                    Text(SpicyLocalizations.of(context)!.brandInTv!,
                        style: Theme.of(context).textTheme.subtitle2!.copyWith(
                            color: Theme.of(context).secondaryHeaderColor)),
                    SizedBox(height: 8.0),
                    Text(SpicyLocalizations.of(context)!.tv!,
                        style: Theme.of(context)
                            .textTheme
                            .caption!
                            .copyWith(color: lightTextColor, fontSize: 10.0)),
            ...
            child: Row(
              ...
              children: <Widget>[
                ...
                Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: <Widget>[
                    Text(SpicyLocalizations.of(context)!.fan!,
                        style: Theme.of(context).textTheme.subtitle2!.copyWith(
                            color: Theme.of(context).secondaryHeaderColor)),
                    SizedBox(height: 8.0),
                    Text(SpicyLocalizations.of(context)!.fan!,
            ...
            child: Row(
              ...
              children: <Widget>[
                ...
                Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: <Widget>[
                    Text(SpicyLocalizations.of(context)!.headBluetooth!,
                        style: Theme.of(context).textTheme.subtitle2!.copyWith(
                            color: Theme.of(context).secondaryHeaderColor)),
                    SizedBox(height: 8.0),
                    Text(SpicyLocalizations.of(context)!.headSet!,
                        style: Theme.of(context)
                            .textTheme
                            .caption!
                            .copyWith(color: lightTextColor, fontSize: 10.0)),
            ...
            child: Row(
              ...
              children: <Widget>[
                ...
                Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: <Widget>[
                    Text(SpicyLocalizations.of(context)!.playStation!,
                        style: Theme.of(context).textTheme.subtitle2!.copyWith(
                            color: Theme.of(context).secondaryHeaderColor)),
                    SizedBox(height: 8.0),
                    Text(SpicyLocalizations.of(context)!.play!,
                        maxLines: 1,
                        style: Theme.of(context)
                            .textTheme
                            .caption!
